...
public class LoginView extends JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setBackground(EstiloComputaDetran.AMARELO);
        btnLogin.setForeground(EstiloComputaDetran.PRETO);

        btnCadastro.setBackground(EstiloComputaDetran.BRANCO);
        btnCadastro.setForeground(EstiloComputaDetran.PRETO);
    ...
    private void abrirTelaAposLogin(String cpf) {
        this.dispose();
