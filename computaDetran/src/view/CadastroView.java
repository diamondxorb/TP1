...
public class CadastroView extends JFrame {
    ...
    private void atualizarCamposEspecificos() {
        ...
        switch (perfil) {
            ...
            case "Vistoriador":
                ...
                /*
                gbc.gridy = 0;
                panelCamposEspecificos.add(new JLabel("Cadastro Detran:"), gbc);

                gbc.gridy = 1;
                txtCadastroDetran = new JTextField(20);
                panelCamposEspecificos.add(txtCadastroDetran, gbc);

                gbc.gridy = 2;
                panelCamposEspecificos.add(new JLabel("Assinatura:"), gbc);

                gbc.gridy = 3;
                txtAssinatura = new JTextField(20);
                panelCamposEspecificos.add(txtAssinatura, gbc);
                break;
    ...
    private void realizarCadastro(ActionEvent e) {
        ...
        int numIdentif = 0;
        String cadastroDetran = null;
        String assinatura = null;

        if (perfil.equals("Vistoriador")) {
            cadastroDetran = txtCadastroDetran.getText();
            assinatura = txtAssinatura.getText();
            if (cadastroDetran.isEmpty()) {
